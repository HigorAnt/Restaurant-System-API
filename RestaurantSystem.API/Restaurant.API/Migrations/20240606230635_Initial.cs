    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IngredientsSnack", x => new { x.IngredientesId, x.SnacksId });
                    table.ForeignKey(
                        name: "FK_IngredientsSnack_Ingredientes_IngredientesId",
                        column: x => x.IngredientesId,
                        principalTable: "Ingredientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IngredientsSnack_Snacks_SnacksId",
                        column: x => x.SnacksId,
            ...
            migrationBuilder.InsertData(
                table: "IngredientsSnack",
                columns: new[] { "IngredientesId", "SnacksId" },
                values: new object[,]
                {
                    { 1, 1 },
                    { 1, 3 },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IngredientsSnack_SnacksId",
                table: "IngredientsSnack",
                column: "SnacksId");
        }
